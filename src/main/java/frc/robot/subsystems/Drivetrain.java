...
public class Drive_Train {
  ...
  private SparkMax leftMotor1 = new SparkMax(0, MotorType.kBrushless);//change based on our driver station
  SparkMax leftMotor2 = new SparkMax(1, MotorType.kBrushless);//change based on our driver station
  SparkMax rightMotor1 = new SparkMax(2, MotorType.kBrushless);//change based on our driver station
  SparkMax rightMotor2 = new SparkMax(3, MotorType.kBrushless);//change based on our driver station
  Joystick joy1 = new Joystick(0);// change channel base on our driver station
  double startTime;
  SparkMax leftmaster = new SparkMax(4, MotorType.kBrushless);//change based on our driver station
  SparkMax rightmaster = new SparkMax(5, MotorType.kBrushless);//change based on our driver station
  SparkMax leftslave = new SparkMax(6, MotorType.kBrushless);//change based on our driver station
  SparkMax rightslave = new SparkMax(7, MotorType.kBrushless);//change based on our driver station
  SparkMax armmotor = new SparkMax(8, MotorType.kBrushless);// chnage channel base on our driver station
  SparkMax armslave = new SparkMax(7, MotorType.kBrushless);// chnage channel base on our driver station
  
  SparkMax rollermotor = new SparkMax(7, MotorType.kBrushless);// change channel based on our driver station

  private Compressor compressor = new Compressor(null);
  private DoubleSolenoid hatchintake = new DoubleSolenoid(null, 0, 1); // chnage channel base on our driver station
